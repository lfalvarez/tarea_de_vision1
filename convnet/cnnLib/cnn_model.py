...
def model_fn (features, labels, mode, params):
    ...
    if params['arch'] == 'DIGIT':
        ...
        net = arch.simple_fn(features, params['image_shape'], params['number_of_classes'], params['number_of_channels'], is_training)    
    elif params['arch'] == 'SKETCH':
        net = arch.sketch_fn(features, params['image_shape'], params['number_of_classes'], params['number_of_channels'], is_training)    
    else :
    ...
    if mode == tf.estimator.ModeKeys.PREDICT:
        ...
        #to avoid initialized each time this module in called
        if mode == tf.estimator.ModeKeys.TRAIN and not already_initialized(params['model_dir']):             
            ...
            if 'ckpt' in params:
                if params['ckpt'] is not None:
                    ...
                    mark_as_initialized(params['model_dir'])
